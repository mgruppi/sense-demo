...
class Alignment:
    ...
    def __init__(self, wv1, wv2, name, alignment_config):
        ...
        wv1_aligned = alignment_config.align(wv1, wv2)[0]
        ...
        self.a_b = perform_mapping(wv1_aligned, wv2)
        # nearest neighbors in a for each word in b
        self.b_a = perform_mapping(wv2, wv1_aligned)
    ...
    def compute_shifts(self, wv1, wv2):
        ...
        """
        d_cosine = np.array([cosine(u, v) for u, v in zip(wv1.vectors, wv2.vectors)])
